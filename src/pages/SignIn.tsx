    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md z-10 bg-card/80 backdrop-blur-xl border-border shadow-2xl">
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            <CardTitle className="text-3xl font-bold glow-cyan">Welcome Back</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            {error && (
              <div className="flex items-center gap-2 p-3 bg-destructive/10 border border-destructive/50 rounded-md text-destructive">
